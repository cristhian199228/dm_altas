...
class AtencionMedicamentoExport implements FromView, ShouldAutoSize, WithEvents, WithDrawings
{
    /**
    ...
    */
    ...
    {
        return view('excel.atencion_medicamentos', [
            'medicamentos' => $this->data
        ]);
    }
