...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style=" border: 2px solid black;text-align:center;">{{ $medicamento->estacion && $medicamento->estacion->sede && $medicamento->estacion->sede->descripcion ?:'' }}</td>
            <td style=" border: 2px solid black;text-align:center;">{{ $medicamento->estacion && $medicamento->estacion->nombre_estacion ?:'' }}</td>
            <td style=" border: 2px solid black;text-align:center;">{{ strtoupper($medicamento->user && $medicamento->user->nombres) ?:'' }} {{ strtoupper($medicamento->user && $medicamento->user->apellidos) ?:'' }}</td>
