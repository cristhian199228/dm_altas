...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style=" border: 2px solid black;text-align:center;">{{ $medicamento->estacion->sede->descripcion ?:'' }}</td>
            <td style=" border: 2px solid black;text-align:center;">{{ $medicamento->estacion->nombre_estacion ?:'' }}</td>
            <td style=" border: 2px solid black;text-align:center;">{{ strtoupper($medicamento->user->nombres) ?:'' }} {{ strtoupper($medicamento->user->apellidos) ?:'' }}</td>
